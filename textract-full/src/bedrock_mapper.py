...
def get_system_prompt(category: Literal["license", "receipt", "bank-receipt" "idcard", "passport"]):
...
def extract_fields(textract_log: str, category: Literal["license", "receipt", "bank-receipt", "idcard", "passport"], region: str, profile: Optional[str] = None, custom_prompt: str = None, use_custom: bool = False):
